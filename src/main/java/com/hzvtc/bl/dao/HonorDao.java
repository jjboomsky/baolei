...
public interface HonorDao {
	 ...
	 * @return
	 */
    int updateHonor(@Param("enti") Honor value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyHonor(@Param("enti") Honor value, @Param("assist") Assist assist);
}