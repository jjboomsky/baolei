...
public interface CourseDao{
	 ...
	 * @return
	 */
    int updateCourse(@Param("enti") Course value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyCourse(@Param("enti") Course value, @Param("assist") Assist assist);
}