...
public interface ReachDao{
	 ...
	 * @return
	 */
    int updateReach(@Param("enti") Reach value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyReach(@Param("enti") Reach value, @Param("assist") Assist assist);
